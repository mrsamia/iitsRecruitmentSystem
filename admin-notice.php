...
<div class="container">
    ...
    <form style="width: 500px; margin: 0 auto; padding: 30px;" align="center" action="admin-notice.php" method="post">
...
if (isset($_POST['submit'])) {
    ...
    $title = $_POST['title'];
    $notice = $_POST['notice'];
    $sql = "INSERT INTO notice(`notice_date`,`title`,`notice`) VALUES('$date','$title','$notice')";
